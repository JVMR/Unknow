                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="GestionarLES?operacion=listarCargoxNombre&nom=<%=empleado.getIdCargo() %>"><i class="fa fa-angle-double-right"></i>Gestionar LES</a></li>
                           </ul>
                        </li>                  
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a>Generar LES</a></li>                
                    </ol>
                </section>
				<%
                    	...
                    	<form action="">
			                                    ...
			                                    <div class="row"> 
			                                    	<div class="col-md-10">
                                            			...
                                            			<div class="form-group">
                                      						...
                                      						<input type="text" class="form-control" id="cantidad" name="txtDias" disabled>
                                            			</div>
                                            			<div class="form-group">
                                            			 	<div class="form-group">
			                                    	...
			                                    	<div class="col-md-11">
			                                    		<div class="form-group">
                                      						...
                                      						<select class="form-control" name="cboLicencia">
				                                                ...
				                                                <option value="0">Enfermedad Común</option>
				                                                <option value="1">Neoplásica</option>
				                                                <option value="2">T.B.C</option>
				                                            </select>
                                            			</div>
                                            			<div class="form-group">
                    		...
                    		<div class="box-footer">
                             	<button class="btn btn-primary" type="submit" >Enviar <i class="fa fa-arrow-circle-right"></i></button>  
                           		<button class="btn btn-primary" type="submit" >Cancelar <i class="fa fa-arrow-circle-right"></i></button>  
                            	<button class="btn btn-primary" type="submit" >Vista Previa<i class="fa fa-arrow-circle-right"></i></button>  
                             </div><!-- Fin Box-Footer -->
                    	</form>                    
                    </div> 
                </section><!-- /.content -->                    
