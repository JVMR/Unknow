    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                       ...
                       <li class="treeview" style="<%=mnu.getgLES()%>">
                        ...
                        <li class="treeview active" style="<%=mnu.getRprt()%>">
                            ...
                            <ul class="treeview-menu">
								...
								<li  class="active"><a href="reporte2.jsp"><i class="fa fa-angle-double-right"></i>Reporte Empleado</a></li>
            ...
            <aside class="right-side">              
				...
				<div align="center" >
				    <iframe frameborder="0"  height="1000" width="800" src="http://127.0.0.1:60580/viewer/preview?__report=D%3A%5CDocumentos%5CECLIPSE%5CReporte%5CReportes_LP2%5CReporte_Empleados.rptdesign&__format=html&__svg=true&__locale=es_PE&__timezone=America%2FBogota&__masterpage=true&__rtl=false&__cubememsize=10&__resourceFolder=D%3A%5CDocumentos%5CECLIPSE%5CReporte%5CReportes_LP2&__dpi=96&__emitterid=org.eclipse.birt.report.engine.emitter.html&1321914783" ></iframe>
					<br>
					<h1>
					<a href="http://127.0.0.1:60580/viewer/preview?__report=D%3A%5CDocumentos%5CECLIPSE%5CReporte%5CReportes_LP2%5CReporte_Empleados.rptdesign&__format=pdf&__svg=true&__locale=es_PE&__timezone=America%2FBogota&__masterpage=true&__rtl=false&__cubememsize=10&__resourceFolder=D%3A%5CDocumentos%5CECLIPSE%5CReporte%5CReportes_LP2&__dpi=96&__emitterid=org.eclipse.birt.report.engine.emitter.pdf&368639142">Generar PDF</a>
					</h1>  
				</div>
