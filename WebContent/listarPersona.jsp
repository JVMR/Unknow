           ...
           <aside class="left-side sidebar-offcanvas"> <!-- Inicio del Menu -->               
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="GestionarPersona?operacion=listarPersona"><i class="fa fa-angle-double-right"></i> Listar Persona</a></li>
                           </ul>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
					...
					<li class="active">Listar Persona</li>
                    </ol>
                </section>
					...
					este es el centro
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                 <h3 class="box-title" align="center">Listado de Persona</h3>   
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive" >
                                <display:table name="Personas" id="aux" requestURI="GestionarPersona?operacion=listarPersona" class="table table-bordered table-striped">
                                	<display:column property="nDNI" title="DNI"></display:column> 
                                	<display:column property="nombre" title="Nombre Completo"></display:column>      
                                	<display:column title="Sexo">
                                			<c:choose>
                                						<c:when test="${aux.getSexo().equals('Masculino') }">
                                						<span class="label label-primary">Masculino</span>
                                						</c:when>
                                						<c:when test="${aux.getSexo().equals('Femenino') }">
                                						<span class="label label-danger">Femenino</span>
                                						</c:when>
                                					</c:choose>
                                	</display:column>
                                	<display:column property="fechaNac" title="Nacimiento"></display:column>  
                                	<display:column property="direccion" title="Direccion"></display:column> 
                                	<display:column property="telefono" title="Telefono"></display:column>   
                                	<display:column title="Email">
                                					<span class="label label-warning">${aux.getEmail() }</span>                              	
                                	</display:column>  
                                	<display:column property="idDistrito" title="Distrito"></display:column>  
                                	<display:column property="idProv" title="Provincia"></display:column>    
                                	<display:column property="idDepart" title="Departamento"></display:column>
                                	...
                                	<div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="GestionarPersona?operacion=cargarPersona&id=${aux.getnDNI()}"><i class="fa fa-edit"></i> Modificar</a></li>
                                                <li><a href="GestionarPersona?operacion=eliminarPersona&id=${aux.getnDNI()}"><i class="fa fa-times-circle"></i> Eliminar</a></li>
                                            </ul>
                                        </div>   
                                	</display:column>                            
                                </display:table>
