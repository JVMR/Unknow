                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                       ...
                       <li class="treeview">
                        	...
                        	<ul class="treeview-menu">
                                <li><a href="cun7.jsp"><i class="fa fa-angle-double-right"></i>Generar Resolucion administrativa de LES</a></li>
                           </ul>
                        </li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <small>Todos los Equipos de las Unidades Orgánicas del INR Dra. Adriana Rebaza Flores</small>
                    </h1>
                    <!-- Modificar al crear nuevos -->
                    <ol class="breadcrumb">
                        <li><a href="bienvenido.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Unidad Organica</a></li>
                        <li class="active">Listar Unidade Orgánica</li>
                    </ol>
                </section>
					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Listado de Equipos de Unidades Orgánicas</h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body table-responsive">
                               ...
                               <display:table name="tbEquipos" id="tbE"  requestURI="gestionarEquipo?operacion=listarEquipos" class="table table-bordered table-striped">
                               	...
                               	<display:column property="descripcionEquipo" title="DESCRIPCIÓN DE EQUIPO"></display:column>
                               	<display:column property="idUnidadOrganica" title="ID UNIDAD ORGÁNICA"></display:column>
                               	<display:column property="cantidadCargo" title="NÚMERO DE CARGO"></display:column>
