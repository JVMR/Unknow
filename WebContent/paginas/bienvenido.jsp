...
<html>
    ...
    <body class="skin-blue">
			<%
          	Usuario usuario= (Usuario) session.getAttribute("USUARIO_LOGEADO");
          %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><%=usuario.getNombresEmpleado() %><%=usuario.getApellidoPaterno() %> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    <img src="img/avatar3.png" class="img-circle" alt="User Image" />
                                    <p>
                                    	<%=usuario.getNombresEmpleado() %>  <%=usuario.getApellidoPaterno() %><br/>
                                        <%=usuario.getIdCargo() %>
                                        <small>Asalariado desde <%=usuario.getFechaIngresoEmpleo() %></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>Hola, <%=usuario.getNombresEmpleado() %></p>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="../widgets.html">
                                <i class="fa fa-th"></i> <span>Cargo</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-edit"></i> <span>Licencia de Enfermedad Subsidiada</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-table"></i> <span>Resolución de LES</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="../calendar.html">
                                <i class="fa fa-calendar"></i> <span>Horario Laboral</span>
