...
<html>
    ...
    <body class="skin-blue">
    	<!-- Recupero datos de usuario que ingreso -->
    	<%
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="img/avatar3.png" class="img-circle" alt="User Image" />
                                    <p><%=usuario.getNombresEmpleado() %>  <%=usuario.getApellidoPaterno() %><br/>
                                        <%=usuario.getIdCargo() %>
            ...
            <aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li>
                            <a href="paginas/bienvenido.jsp">
                                <i class="fa fa-dashboard"></i> <span>Bienvenido</span>
                            </a>
                        </li>
                        <li>
                            <a href="../widgets.html">
                                <i class="fa fa-th"></i> <span>Perfil</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
