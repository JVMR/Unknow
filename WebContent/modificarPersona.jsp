       ...
       <header class="header">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
          ...
          <aside class="left-side sidebar-offcanvas"> <!-- Inicio del Menu -->               
			...
			<%
    		Persona objPer= (Persona) request.getAttribute("daoPersona");
    		%>
                ...
                <section class="content">               	               
                            ...
                            <div class="box box-primary">
                               ...
                               <form action="GestionarPersona" method="post" enctype="multipart/form-data" >
                               		<div class="box-body">
                               		<input type="hidden" name="operacion" value="actualizarPersona">
                                     <!-- Empleado -->     
                                       <div class="row">       
                                       		<div class="col-md-12">
                                      	...
                                      	<div class="col-md-6">
                                      		<div class="form-group">
                                      			<label>DNI :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese tu numero de DNI" name="txtDNI" value="<%=objPer.getnDNI()%>">
                                            </div>
                                      	    <div class="form-group">
                                      			<label>Nombre :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese nombre completo" id="Nombre" name="txtNombre" value="<%=objPer.getNombre()%>">
                                            </div>
                                            <div class="form-group">
                                      			<label>Apellido Paterno :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese apellido Paterno" id="ApellidoP" name="txtApellidoP" value="<%=objPer.getApeP()%>">
                                            </div>
                                            <div class="form-group">
                                      			<label>Apellido Materno :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese apellido Materno" name="txtApellidoM" value="<%=objPer.getApeM()%>">
                                            </div>
                                            <div class="form-group">
                                      			<label>Sexo :</label>
                                      			<input type="text" class="form-control"  name="txtSexo" value="<%=objPer.getSexo()%>" disabled>                                        			
                                      			<input type="hidden" name="cboSexo" value="<%=objPer.getSexo()%>">                                          
                                            </div>
                                            <div class="form-group">
                                      			<label>Fecha Nacimiento :</label>
                                            		...
                                            		<input type="text" class="form-control"  name="txtFechaN" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask value="<%=objPer.getFechaNac()%>"/>
                                            ...
                                            <div class="form-group">
                                      			...
                                      			<div class="input-group">
                                           			 ...
                                           			 <input type="text" class="form-control" name="txtFono" data-inputmask='"mask": "999-999-999"' data-mask value="<%=objPer.getTelefono()%>"/>
                                        		</div><!-- /.input group -->
                                            </div>
                                            <div class="form-group">
                                      			<label>Direccion :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese apellido Materno" name="txtDireccion" value="<%=objPer.getDireccion()%>">
                                           </div>                                            
                                            <div class="form-group">
                                      			<label>Correo Electronico :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese apellido Materno" name="txtEmail" value="<%=objPer.getEmail()%>">
                                           </div>                                            
                                          </div> 
                                          <div class="col-md-5">
                                          		<div class="form-group">
                                           		  ...
                                           		  <div class="row">   
                                           		     <div class="col-md-6">
		                                           		 <div class="form-group">
					                                      		...
					                                      		<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="GestionarPersona?operacion=fotoPersona&id=<%=objPer.getnDNI()%>" alt="">
																	</div>
		                                      	     ...
		                                      	     <div class="col-md-5">
		                                      	          <div class="form-group">
					                                      		...
					                                      		<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="fileupload-new thumbnail" style="width: 200px; height: 100px;"><img src="GestionarPersona?operacion=firmaPersona&id=<%=objPer.getnDNI()%>" alt="">
																	</div>
