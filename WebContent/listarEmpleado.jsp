				 ...
				 <!-- 	<div id="centro">
					este es el centro
                            ...
                            <div class="box box-primary">
                                ...
                                <display:table name="Empleados" id="aux" requestURI="GestionarEmpleado?operacion=listarEmpleado" class="table table-bordered table-striped">
                                	<display:column property="idEmpleado" title="ID"></display:column> 
                                	<display:column property="nDNI" title="DNI"></display:column>      
                                	<display:column property="nombresEmpleado" title="Nombre"></display:column>
                                	<display:column property="telefono" title="Celular"></display:column>  
                                	<display:column property="idCargo" title="Cargo"></display:column>  
                                	...
                                	<display:column property="usuario" title="Usuario"></display:column>  
