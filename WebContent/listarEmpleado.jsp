...
<html>
    <head>
        ...
        <!-- User Table -->
        <link href="css/datatables/userTables.bootstrap.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active" style="<%=mnu.getMant()%>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="GestionarEmpleado?operacion=listarEmpleado"><i class="fa fa-angle-double-right"></i> Listar Empleado</a></li>
                           </ul>
					...
					este es el centro
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                 <h3 class="box-title" align="center">Listado de Empleado</h3>   
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive" >
                                <display:table name="Empleados" id="aux" requestURI="GestionarEmpleado?operacion=listarEmpleado" class="table user-list">
                                	<display:column  title="ID" class="text-center">
                                		<img src="GestionarEmpleado?operacion=fotoEmpleado&id=${aux.getIdEmpleado()}" class="img-circle" alt="User Image">
                                        <a href="#" class="user-link">${aux.getNombresEmpleado()}</a>
                                        <span class="user-subhead">${aux.getIdCargo()}</span>
                                	</display:column> 
                                	<display:column property="nDNI" title="DNI" ></display:column>      
                                	<display:column property="telefono" title="Celular"></display:column> 
                                	<display:column title="Estado">
                                					<c:choose>
                                						<c:when test="${aux.getIdEstado().equals('Activo') }">
                                						<i class="fa fa-circle text-success"></i>
                                						</c:when>
                                						<c:when test="${aux.getIdEstado().equals('Inactivo') }">
                                						<i class="fa fa-circle text-danger"></i>
                                						</c:when>
                                					</c:choose>                                	
                                	</display:column>  
                                	<display:column property="fechaIngreso" title="Fecha Ingreso"></display:column>  
                                	<display:column title="Usuario"><span class="badge bg-yellow">${aux.getUsuario()}</span></display:column>  
                                	...
                                	<div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="GestionarEmpleado?operacion=cargarEmpleado&id=${aux.getIdEmpleado()}"><i class="fa fa-edit"></i> Modificar</a></li>
                                                <li><a href="GestionarEmpleado?operacion=eliminarEmpleado&id=${aux.getIdEmpleado()}"><i class="fa fa-times-circle"></i> Eliminar</a></li>
                                            </ul>
                                        </div>   
                                	</display:column>                            
                                </display:table>
