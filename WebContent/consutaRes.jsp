                       ...
                       <li class="treeview" style="<%=mnu.getgLES()%>">
                        ...
                        <li class="treeview active" style="<%=mnuInactivo%>">
                        	...
                        	<ul class="treeview-menu">
                                ...
                                <li class="active" style="<%=mnu.getlRES()%>"><a href="consutaRes.jsp"><i class="fa fa-angle-double-right"></i>Consultar Solicitud RES</a></li>
					...
					este es el centro
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                 <h3 class="box-title" align="center">Listado de Solicitudes RES</h3>   
                                </div><!-- /.box-header -->
                                
                                <div class="box-body table-responsive" >
                        <form action="gestionarRES">
                                <input type="hidden" value="consultarResxRango" name="operacion" >
                                <div class="form-group">
                                				<label>Fecha Desde :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese una Fecha" name="txtFecha1" value="">
                                			</div>
                                <div class="form-group">
                                				<label>Fecha Hasta :</label>
                                      			<input type="text" class="form-control" placeholder="Ingrese una Fecha" name="txtFecha2" value="">
                                			</div>
                                <div class="form-group">
                                      			<label>Estado :</label>
                                      			<cbo:cboDinamico sql="SQL_ESTADORES" nombre="cboEstadoRes" id="cboEstadoRes"/>
                                            </div>
                                <button class="btn btn-primary" type="submit" >Consultar</button>
                                
                                <display:table name="Res" id="aux" requestURI="gestionarRES?operacion=consultarResxRango" class="table table-bordered table-striped">
                                	<display:column property="idRes" title="ID"></display:column> 
                                	<display:column property="referencia" title="Referencia"></display:column>      
                                	<display:column property="descriptor" title="Descriptor"></display:column>
                                	<display:column property="objetoConsulta" title="Objeto Consuta"></display:column>  
                                	<display:column property="analisis" title="Analisis"></display:column>  
                                	<display:column property="fechaGenerado" title="Fecha Generado"></display:column>  
                                	<display:column property="idLes" title="IdLes"></display:column>
                                	<display:column title="Estado"><span class="label label-warning">${aux.getIdEstado()}</span></display:column>    
                                	<display:column property="idAsalariado" title="F. Hora"></display:column>
                                	...
                                	<div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="gestionarRES?operacion=cargarRes&id=${aux.getIdRes()}"><i class="fa fa-edit"></i>Actualizar RES</a></li>
                                            </ul>
                                        </div>   
                                	</display:column>      
                                </display:table>
