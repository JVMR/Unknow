        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Mantenimiento Unidades Orgánicas
                        <small>Permite registrar, actualizar y eliminar datos de Unidades Orgánicas</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="bienvenido.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active">Unidad Orgánica</a></li>                  
                    </ol>
                </section>
                ...
                <section class="content">              
					<h4 class="page-header">
                        Mantenimiento de Unidades Orgánics
                        <small>Recomendación : Para Actualizar o Eliminar una Unidad Orgánica, primero busque en Listado de Unidad Orgánica</small>
                    </h4>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    ...
                                    <p>
                                        Registro de Unidades Orgánicas
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-ios7-pricetag-outline"></i>
                                </div>
                                <a href="registraUnidadOrganica.jsp" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    ...
                                    <p>
                                       Listado de Unidades Orgánicas
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-pie-graph"></i>
                                </div>
                                <a href="gestionarUnidadOrganica?operacion=listarUnidad" class="small-box-footer">
                                    Ir a la Pagina<i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
