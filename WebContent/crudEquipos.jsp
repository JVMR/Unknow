					...
					<li class="dropdown user user-menu"><a href="#"
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header bg-light-blue"><img
								...
								<p><%=empleado.getNombresEmpleado()%>
									<%=empleado.getApellidoPaterno()%><br />
									<%=empleado.getIdCargo()%>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="left-side sidebar-offcanvas">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					<li><a href="paginas/bienvenido.jsp"> <i
							class="fa fa-dashboard"></i> <span>Bienvenido</span>
					</a></li>
					<li><a href="../widgets.html"> <i class="fa fa-th"></i> <span>Perfil</span>
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					Unidades Orgánicas <small>Todas las oficinas del INR Dra.
				...
				<div class="row">
		            ...
		            <div class="col-md-11" style="padding-left: 80px">
						  ...
						  <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" name="unidad">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="txtNombreUnidad">Nombre de Unidad</label>
                                            <input type="text" class="form-control" id="txtNombreUnidad" name="txtNombreUnidad" placeholder="Ingrese Nombre de Unidad u Oficina">
                                        </div>
                                        <div class="form-group">
                                            <label for="txtDescripcionUnidad">Descripción</label>
                                            <input type="text" class="form-control" id="txtDescripcionUnidad" name="txtDescripcionUnidad" placeholder="Ingrese una descripción">
                                        </div>
                                        <div class="box-header">
		                                    <h3 class="box-title">Cargos  <small>Agregar los cargos a considerarse</small> </h3>
		                                </div><!-- /.box-header -->
                                        
                                       <div class="form-group">
                                            <label for="txtNombreCargo">Nombre de Cargo</label>
                                            <input type="text" class="form-control" id="txtNombreCargo" name="txtNombreCargo" placeholder="Ingrese Nombre">
                                        </div>
                                        <div class="form-group">
                                           <label for="txtSueldo">Sueldo del Cargo</label>
                                        <div class="input-group">
										<span class="input-group-addon">$</span>
										<input class="form-control" type="text" name="txtSueldo"></input>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="deleteRow('tablaCargo')">Eliminar Cargo</button>
                                    
                                   <!-- 
                                        <button type="button" class="btn btn-primary" onclick="llenarTablaCargo('tablaCargo')">Agregar Cargo</button>
                                        <button type="button" class="btn btn-primary" onclick="addRow('dataTable')">Eliminar Cargo</button> --> 
                               ...
                               <div class="box">
									 <div class="box-body table-responsive">      
										<table id="tablaCargo" class="table table-bordered table-striped dataTable" aria-describedby="example1_info"> 
											<thead>
												<tr role="row">
													<th>Elegir</th>
													<th>Cargo</th>
                                 ...
                                 <div class="box-footer" align="center">
                                        <button type="button" class="btn btn-primary" onclick="datosTextos()">Grabar Nueva Unidad</button>
                                    </div>
