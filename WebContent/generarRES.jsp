	...
	<body class="skin-blue">
       ...
       <header class="header">
                    ...
                    <ul class="sidebar-menu">
                       ...
                       <li class="treeview">
                        ...
                        <li class="treeview active">
                        	...
                        	<ul class="treeview-menu">
                                <li class="active"><a href="generarRES.jsp"><i class="fa fa-angle-double-right"></i>Generar Resolucion administrativa de LES</a></li>
       	...
       	<input type="hidden" value="registraRES" name="operacion" >
               ...
               <div class="form-group">
               		<label>De  :</label>               	
               		<input type="text" class="form-control" placeholder="Escriba ..."   value="<%=empleado.getNombresEmpleado()%>&nbsp;<%=empleado.getApellidoPaterno()%>">
                </div>
               <div class="form-group">
               		<label>Referencia :</label>               	
               		<input type="text" class="form-control"  placeholder="Escriba ..."  name="txtReferencia">
                </div>
               <div class="form-group">
               		<label>Descriptor :</label>           	
               		<input type="text" class="form-control" value="<%=objRes.getNomEmpleado()%>" placeholder="Escriba ..."  name="txtDescriptor">
                </div>
               <div class="form-group">
               		<label>Fecha :</label>         	
               		<div class="input-group">
                                            		...
                                            		<input type="text" class="form-control"  name="txtFechaG" value="<%=fecha.format(new Date())%>" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask/>
               ...
               <div class="form-group">
               		<input type="text" class="form-control"   name="txtObjetoConsulta" style="width: 200px;height: 80px;" />  	
                </div>
               <div class="form-group">
               		<label>II. Análisis :</label>	
                </div>
               <div class="form-group">
               		<input type="text" class="form-control"  name="txtAnalisis" style="width: 200px;height: 80px;" />   	
                </div>       	
         	<label>Se resuelve que la licencia por enfermedad subsidiada con codigo <input type="text" name="txtIdLes" value="<%=objRes.getIdLes()%>" />  del asalariado <input type="text" name="txtidAsalariado" value="<%=empleado.getIdEmpleado()%>" /><br /> 
