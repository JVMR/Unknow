            ...
            <aside class="right-side">                
                ...
                <section class="content">               	               
                            ...
                            <div class="box box-primary">
                               ...
                               <form action="GestionarEmpleado" method="post" enctype="multipart/form-data" id="ingresaEmpleado">
                               		<div class="box-body">
                                      	...
                                      	<div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                      			...
                                      			<div class="input-group">
                                           			 ...
                                           			 <input type="text" class="form-control" name="txtSeguroSocial" data-inputmask='"mask": "99999999999"' data-mask/>
                                        		</div><!-- /.input group -->                                      			
                                            </div>
                                            <div class="form-group">
                                      			<label>Cargo :</label>
                                      			<cbo:cboDinamico sql="SQL_CARGO" nombre="cboCargo"/>
                                            </div>
                                            <div class="form-group">
                                      			<label>Estado :</label>
                                      			<cbo:cboDinamico sql="SQL_ESTADO" nombre="cboEstado"/>
                                            </div>
                                            <div class="form-group">
                                      			...
                                      			<div class="input-group">
                                            		...
                                            		<input type="text" class="form-control"  name="txtFechaI" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask/>
                                          ...
                                          <div class="col-md-5">
												...
												<div class="input-group">													
                                      				 <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                                       				 <input class="form-control" placeholder="Usuario" type="text" id="Usuario" name="txtUsuario" disabled>
                                   				</div>
                                      			<label>Password :</label>
                                      			<div class="input-group">													
                                      				 <span class="input-group-addon"><i class="fa fa-fw fa-key"></i></span>
                                       				 <input class="form-control" placeholder="Password" type="password" name="txtPssword1">
                                   				</div>
                                   				<label>Confirmar Password :</label>
                                      			<div class="input-group">													
                                      				 <span class="input-group-addon"><i class="fa fa-fw fa-key"></i></span>
                                       				 <input class="form-control" placeholder="Confirmar Password" type="password" name="txtPssword">
                                   				</div>
                                            </div>
