...
<head>
<meta charset="UTF-8">
<title>Lista cargo de equipos para modificar</title>
<meta
	...
	<form role="form" name="equipo" action="gestionarEquipo" >
				<div class="box-body">
							...
							<div class="col-md-11">
								...
								<a   href="gestionarEquipo?operacion=listarCargoxModificar"  ondblclick="oculta()"   id="pepe" >Refrescar Cargo</a> 
                              	...
                              	<display:column title="OPERACIÓN">
                              		<div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="gestionarEquipo?operacion=quitarCargoModificacion&idItem=${tbE.getItemCargo()}&idCargo=${tbE.getIdCargo()}"><i class="fa fa-times-circle"></i> Eliminar</a></li>
                                            </ul>
                                    </div>   
                              	</display:column>
