					...
					este es el centro
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                 <h3 class="box-title" align="center">Listado de Solicitudes LES</h3>   
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive" >
                                
                                <display:table name="Les" id="aux" requestURI="gestionaLES?operacion=listarLes" class="table table-bordered table-striped">
                                	...
                                	<div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="GestionarEmpleado?operacion=cargarEmpleado&id=${aux.getIdEmpleado()}"><i class="fa fa-edit"></i>Generar RES</a></li>
