...
<html class="bg-black">
    ...
    <body class="bg-black">
        ...
        <div class="form-box" id="login-box">
            <div class="header">Benvenido a:<br/> INR Dra. Adrian Rebaza Florez</div>
            <!--  <form action="../../index.html" method="post"> -->
            <form action="login" method="post">
                <div class="body bg-gray">
                    <div class="form-group">
                        <input type="text" name="txtUsuario" class="form-control" placeholder="User ID"/>
                    </div>
                    <div class="form-group">
                        <input type="password" name="txtPassword" class="form-control" placeholder="Password"/>
                    </div>          
                    <div class="form-group">
                        <input type="checkbox" name="chkRemember_me"/> Remember me
                    </div>
                </div>
                ...
                <div class="footer">                                                               
                    ...
                    <p><a href="#">Perdí mi contraseña</a></p>
