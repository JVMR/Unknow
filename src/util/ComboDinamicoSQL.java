...
public class ComboDinamicoSQL extends TagSupport{
...
public void setId(String id) {
	...
	public int doStartTag() throws JspException {
		...
		Factory bd = Factory.getTipo(Factory.TIPO_SQL_SERVER);
		ComboDao  dao = bd.getCombo();
		
		try {
			out.print("<select class='form-control' name='" + nombre + "' id='"+id+ "'>");
			out.print("<option value='-1'>[Seleccione Departamento]</option>");
